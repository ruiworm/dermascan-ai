...
def parse_args(args):
    ...
    parser.add_argument('--sample_ratios', 
                   type=str, 
                   default=None,
                   help='the sampling ratio within a batch - the input should be looks like {"internal":0.5, "molemap":0.5}')
    parser.add_argument('--csv-label-key', type=str, default=None,
                        help="Column name of label for zero shot test CSV.")
    parser.add_argument('--zeroshot-eval', type=str, default=None,
                        help="Path to the CSV file for DermNet zero-shot evaluation.")
    parser.add_argument('--zeroshot-eval1', type=str, default=None,
                        help="Path to the CSV file for PAD zero-shot evaluation.")
    parser.add_argument('--zeroshot-eval2', type=str, default=None,
                        help="Path to the CSV file for HAM-official zero-shot evaluation.")
    parser.add_argument('--zeroshot-eval3', type=str, default=None,
                        help="Path to the CSV file for SNU134 zero-shot evaluation.")
    parser.add_argument('--zeroshot-eval4', type=str, default=None,
                        help="Path to the CSV file for SD128 zero-shot evaluation.")
    parser.add_argument('--zeroshot-eval5', type=str, default=None,
                        help="Path to the CSV file for Daffodil5 zero-shot evaluation.")
    parser.add_argument('--zeroshot-eval6', type=str, default=None,
