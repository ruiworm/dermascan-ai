...
from .factory import create_model_from_pretrained, get_model_config, get_tokenizer, create_model_and_transforms
...
def load_checkpoint(checkpoint_path, model, device):
        ...
        try:
            ...
            print(f"Checkpoint loaded. Missing keys: {len(load_info.missing_keys)}, "
...
def push_pretrained_to_hf_hub(
    ...
    **kwargs,
    ...
    if pretrained and os.path.exists(pretrained):
        print(f"Loading custom checkpoint: {pretrained}")
        model = load_checkpoint(pretrained, model, device)
