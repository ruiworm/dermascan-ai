...
python automated-concept-discovery/0_extract_sae_activations.py \
  ...
  --embeddings automated-concept-discovery-result/ISIC_hair_bias/PanDermv2/train/all_embeddings.npy \
  --output automated-concept-discovery-result/ISIC_hair_bias/PanDermv2/train/learned_activation.npy

python automated-concept-discovery/0_extract_sae_activations.py \
  --checkpoint automated-concept-discovery-result/SAE-embeddings/autoencoder.pth \
  --embeddings automated-concept-discovery-result/ISIC_hair_bias/PanDermv2/test/all_embeddings.npy \
  --output automated-concept-discovery-result/ISIC_hair_bias/PanDermv2/test/learned_activation.npy
...
python automated-concept-discovery/4_intervention_CBM.py \
    ...
    --split test \
    --device cuda \
    --data_dir automated-concept-discovery-result/ISIC_hair_bias/ \
    --result_dir automated-concept-discovery-result/ISIC_hair_bias/PanDermv2 \
